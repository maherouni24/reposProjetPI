 ...
 * @author meher
 */
public class SaZamaController implements Initializable {
    ...
    private void SendToPrevious(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaMaktaris.fxml"));
        try {
            Parent root = loader.load();
            SaMaktarisController skc = loader.getController();
    ...
    private void SendToNext(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaSufetila.fxml"));
        try {
            Parent root = loader.load();
            SaSufetilaController suc = loader.getController();
