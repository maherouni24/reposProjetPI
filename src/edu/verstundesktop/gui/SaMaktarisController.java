 ...
 * @author meher
 */
public class SaMaktarisController implements Initializable {
    ...
    private void SendToNext(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaZama.fxml"));
        try {
            Parent root = loader.load();
            SaZamaController suc = loader.getController();
