 ...
 * @author meher
 */
public class SaUtiqueController implements Initializable {
    ...
    private void SendToNext(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaUthina.fxml"));
        try {
            Parent root = loader.load();
            SaUthinaController suc = loader.getController();
