 ...
 * @author meher
 */
public class SaElJemController implements Initializable {
    ...
    private void SendToPrevious(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaDeCarthage.fxml"));
        try {
            Parent root = loader.load();
            SaDeCarthageController scc = loader.getController();
    ...
    private void SendToNext(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaKerkouane.fxml"));
        try {
            Parent root = loader.load();
            SaKerkouaneController skc = loader.getController();
