 ...
 * @author meher
 */
public class SaUthinaController implements Initializable {
    ...
    private void SendToPrevious(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("SaUtique.fxml"));
        try {
            Parent root = loader.load();
            SaUtiqueController suc = loader.getController();
